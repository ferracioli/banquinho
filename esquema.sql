/* Determina a construção de todas as tabelas usadas no banco de dados */

/* Tabela do USUARIO com seus multivalorados e generalizações */
...
/* Tabela do PONTO TURISTICO com seu multivalorado */
...
/* Tabela da ATIVIDADE com seu multivalorado */
...
/* Tabela do GRUPO DE PARTICIPANTES com seus multivalorados */
...
/* Tabela da ESTADIA com seu multivalorado */
...
/* Tabela das TRANSACOES FINANCEIRAS */
CREATE TABLE TRANSACOES_FINANCEIRAS (
    ...
    CONSTRAINT FK_TRANSACOES_FINANCEIRAS FOREIGN KEY (USUARIO) 
        REFERENCES USUARIO(USERNAME)
        ON DELETE CASCADE,
    CONSTRAINT PK_TRANSACOES_FINANCEIRAS PRIMARY KEY (USUARIO, DATA_TRANSFERENCIA)
);

/* Relacionamentos N:M entre entidades: */

/* Tabela do relacionamento entre USUARIO e TRANSPORTE */
...
/* Tabela do relacionamento entre USUARIO e ESTADIA */
CREATE TABLE OCUPA (
    USUARIO VARCHAR(15) NOT NULL,
    ESTADIA INTEGER NOT NULL,
    CUSTO_ADICIONAL INTEGER,
...
/* Tabela do relacionamento entre USUARIO e ITINERARIO */
...
/* Tabela do relacionamento entre MOCHILEIRO e CARAVANA */
...
/* Tabela do relacionamento entre ESPECIALSITA e CARAVANA */
...
/* Tabela do relacionamento entre USUARIO e GRUPO DE PARTICIPANTES */
CREATE TABLE ENTRA (
    USUARIO VARCHAR(15) NOT NULL,
    ATIVIDADE INTEGER NOT NULL,
    CATEGORIA VARCHAR(30) NOT NULL,
